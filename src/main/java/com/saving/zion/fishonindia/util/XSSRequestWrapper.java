...
public class XSSRequestWrapper extends HttpServletRequestWrapper {
    ...
    private String stripXSS(String value) {
        if (value != null) {
         ...
         // Avoid anything between Image/Body/iframe tags
            ...
            scriptPattern = Pattern.compile("<body>(.*?)</body>", Pattern.CASE_INSENSITIVE);
            value = scriptPattern.matcher(value).replaceAll("");
            scriptPattern = Pattern.compile("<body(.*?)>", Pattern.CASE_INSENSITIVE | Pattern.MULTILINE | Pattern.DOTALL);
            value = scriptPattern.matcher(value).replaceAll("");
